  ...
  const response = [
    {
      ...
      description: "View or upload your O'Level Certificate.",
        ...
        >
          <Container maxWidth="sm" sx={{ mt: "2%" }}>
            ...
            <Typography
              ...
              gutterBottom
            >
              Here you can upload private documents such as your educational
              certificate or even your resume for safekeeping.
            </Typography>
                ...
                >
                  ...
                  <CardActions>
                    <Button
                      ...
                      size="small"
                    >
                      {response.exists ? "Download" : "Upload"}
                    </Button>
                  </CardActions>
                </Card>
              </Grid>
